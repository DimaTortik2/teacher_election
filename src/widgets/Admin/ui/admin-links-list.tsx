...
import { AdminLink } from "../../../features/admin-features";
...
export function AdminLinksList({className}:IProps){
  return (
		<ul className={clsx(className,'flex flex-col md:flex-row items-center justify-center gap-[10vw] sm:gap-[5vw] cursor-pointer')}>
